...
Иерархия разрабатываемых классов должна реализовывать шаблон проектирования Адаптер над классами CircleShape, RectangleShape и ConvexShape библиотеки SFML.
